...
| `ALEXANDRIA_AUTO_RECALL_MIN_SIMILARITY` | `0.58` | Minimum similarity to inject a hit. Measured too high for `all-MiniLM-L6-v2`; set `0.35` (see `[recall]` in [docs/configuration.md](../../docs/configuration.md)) |
